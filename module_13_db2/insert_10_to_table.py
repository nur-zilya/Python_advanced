...
# def input_new_item()-> AddItem:
#     name = input("Enter name: \n>")
#     description = input("Enter description: \n>")
#     amount = input("Enter amount in warehouse: \n>")
#
#     amount_val = int(amount)
#
#     return AddItem(name=name, description=description, amount=amount_val)

def add_10_records_to_table_warehouse(cursor: sqlite3.Cursor) -> None:
    records = [('apple', 'green apple', 100),
               ('tomatoes', 'Italian tomatoes', 50),
               ('bananas', 'little green bananas', 150),
               ('strawberry', 'sweet strawberries', 55),
               ('pinaplle', 'tasty pinaplles', 20),
               ('cucumbers','from dacha', 40),
               ('smth else', 'smth', 0),
               ('smt else', 'ssss', 0),
               ('and one', 'more', 0)]
